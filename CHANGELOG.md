...
- **`docs/superpowers/specs/2026-06-08-halpha-solar-video-design.md`** — design spec for the vertical LinkedIn short presenting the H-alpha solar physics website; defines the `h-alpha` theme cloning the site palette, a 6-scene ~78s escaleta (física → instrumento → imagen), and the reuse of the existing dimension-agnostic scene engine for a 1080×1920 composition
